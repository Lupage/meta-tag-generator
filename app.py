...
#Streamlit front-end
st.set_page_config(layout="wide", page_title="SEO Meta Tag Generator")
with st.form(key='SEO Meta Tag Bulk Generator'):
    col1, col2 = st.columns(2)
    with col1:
        st.header("***SEO Meta Tag Bulk Generator***", anchor=None)
    ...
    with col2:
        ...
        st.markdown("Get your API credentials from [DataForSEO](https://dataforseo.com/?aff=124940). You need these to use this tool. \n\n You can find the credentials under the navgitation bar: API Settings > API access.")
...
try:
    ...
    st.error("Please enter valid and full URLs as well as correct API credentials.", icon="🚨")
